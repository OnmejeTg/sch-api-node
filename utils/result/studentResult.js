...
import { drawHeader, drawStudentInfo, drawScoreSheet, drawAffirmativeSkills, drawPsychomotorSkills, drawSummary, drawFooter } from "./pdfUtils.js";
...
async function generatePDF(student) {
  ...
  const studentPhotoData = await getImageBase64("https://res.cloudinary.com/tgod/image/upload/v1716675830/test/studentProfile/ouxtqdcjjynbgvewx2oj.jpg");
  ...
  const logoData = await getImageBase64("https://res.cloudinary.com/tgod/image/upload/v1717765917/test/h9pcydfkzalhz6lw6qhj.jpg");
  doc.addImage(
    logoData,
    "JPEG",
    PAGE_PADDING,
...
// Usage
  ...
  const sample = {
    ...
    result: {
      subjects: [
        { name: "Mathematics", firstCA: 10, secondCA: 9, test: 8, exam: 70, total: 97, avg: 95, highest: 97, lowest: 90, position: 1, grade: "A" },
        // ...more subjects
      ],
    },
    affirmativeSkills: {
